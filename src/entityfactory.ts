...
class RocketPoolEntityFactory {
  ...
  public createNetworkStakerBalanceCheckpoint(
    ...
    if (id == null || event === null || event.block === null || event.params === null) {
      return null;
    }
   ...
   */
  public createStaker(id: string, blockNumber: BigInt, blockTime: BigInt): Staker | null {
   ...
   */
  public createNode(id: string, timezoneId: string, blockNumber: BigInt, blockTime: BigInt): Node | null {
    if (id == null) return null;
  ...
  public createRPLRewardInterval(
    ...
    rewardInterval.claimableRewardsFromPreviousInterval =
      claimableRewardsFromPreviousInterval < BigInt.fromI32(0) ? BigInt.fromI32(0) : claimableRewardsFromPreviousInterval;
